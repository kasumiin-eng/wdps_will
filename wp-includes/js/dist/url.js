 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://carithy216.xsrv.jp:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'https://carithy216.xsrv.jp:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'https://carithy216.xsrv.jp:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://carithy216.xsrv.jp:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
