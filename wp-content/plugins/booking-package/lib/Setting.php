    ...
    class booking_package_setting {
        ...
        public function getList(){
            ...
            $list =  array(
                "General" => array(
                    ...
                    'automaticApprove' => array('name' => __('Automatic approve of booking', $this->pluginName), 'value' => '0', 'isExtensionsValid' => 0, 'inputLimit' => 2, 'inputType' => 'CHECK', 'valueList' => array('1' => __('Enabled', $this->pluginName))), 
        ...
        public function getElementForCalendarAccount(){
            ...
            $calendarAccount = array(
                ...
                'status' => array('key' => 'status', 'name' => 'Calendar status', 'target' => 'both', 'value' => 'open', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 0, 'option' => 0, 'valueList' => array('open' => __('Open', $this->pluginName), 'closed' => __('Closed', $this->pluginName))),
