		...
		**/
		...
		public function heartbeat() {
			...
			if (intval($_POST['booking_package_heartbeat']) == 1) {
				...
				$array = array('status' => true, 'isExtensionsValid' => $isExtensionsValid, 'pluginVersion' => $this->plugin_version, 'timestamp' => date('U'));
		...
		public function add_pages() {
			...
			**/
			...
			add_submenu_page(__FILE__, $plugin_name, __('Report & Booking', $this->plugin_name),  $editor_cap, __FILE__, array($this,'adomin'));
			...
			$schedule_page = add_submenu_page(__FILE__, $plugin_name, __('Calendar Setting', $this->plugin_name),  $manager_cap, $this->plugin_name.'_schedule_page', array($this,'schedule_page'));
			add_submenu_page(__FILE__, $plugin_name, __('General Setting', $this->plugin_name),  $manager_cap, $this->plugin_name.'_setting_page', array($this,'setting_page'));
		...
		public function schedule_page(){
			...
			wp_enqueue_script('Calendar_js', plugin_dir_url( __FILE__ ).'js/Calendar.js' . $p_v, array(), $this->plugin_version);
			wp_enqueue_script('input_js', plugin_dir_url( __FILE__ ).'js/Input.js' . $p_v, array(), $this->plugin_version);
			wp_enqueue_script('schedule_pange', plugin_dir_url( __FILE__ ).'js/Schedule.js' . $p_v, array('jquery', 'wp-color-picker'), $this->plugin_version);
		...
		public function setting_page(){
			...
			wp_enqueue_script('Confirm_js', plugin_dir_url( __FILE__ ).'js/Confirm.js' . $p_v, array(), $this->plugin_version);
			wp_enqueue_script('Calendar_js', plugin_dir_url( __FILE__ ).'js/Calendar.js' . $p_v, array(), $this->plugin_version);
			wp_enqueue_script('setting_page', plugin_dir_url( __FILE__ ).'js/setting.js' . $p_v, array('jquery', 'wp-color-picker'), $this->plugin_version);
		...
		public function localizeScript($mode){
			...
			if ($mode == 'adomin') {
				...
				if ($this->insertConfirmedPage == 0) {
					
					unset($elementForCalendarAccount['insertConfirmedPage']);
					unset($elementForCalendarAccount['confirmDetailsPage']);
