...
add_filter(
	'wp_nav_menu_items',
	function( $items, $args ) {
		// グローバルナビとドロワーナビにだけ追加する
		if ( in_array( $args->theme_location, [ 'drawer-nav' ] ) ) {
			return $items . '<li class="c-navbar__item">' . do_shortcode( 
			'<div class="my-header-content">
			<div class="header-btn">
				<div class="header-btn_tel">
					完全予約制
					<div class="top-phone">
						<i class="fas fa-phone-alt"></i>  
						<a href="tel:08095706459">
						000-0000-0000
						</a>
					</div>
				</div>
...
add_filter(
	...
	function( $items, $args ) {
		...
		if ( in_array( $args->theme_location, [ 'drawer-nav' ] ) ) {
			return $items . '<li class="c-navbar__item">' . do_shortcode( 
			'<div class="my-header-content">
			<div class="header-btn_btn">
				<a class="smb-btn" href="https://carithy216.xsrv.jp/wdps_snmonprac/contact/">
					<span class="smb-btn_label">
						<span style="font-size: 16px;" class="sme-font-size has-normal-font-size">
							<strong class="typesquare_option">ご予約はこちら
							</strong>
						</span>
					</span>
				</a>
